...
const AppointmentForm = ({
  ...
  const form = useForm({
    ...
    defaultValues: {
      make: appointment ? appointment.make : '',
      model: appointment ? appointment.model : '',
      year: appointment ? appointment.year : '',
      registrationNumber: appointment ? appointment.registrationNumber : ''
    }
  });
  ...
  const onSubmit = async (data) => {
    try {
      if (appointment) {
        await formAction(data, appointment.id);
      } else {
